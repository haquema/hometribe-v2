  ...
  return (
        <div className="flex flex-col w-full gap-8 p-4 max-w-[500px] self-center">
          ...
          <div className="flex flex-col gap-3">
            <p className="w-full">At hometribe, our mission is simple: to make homeschooling <span className="highlight-red">easier</span>, <span className="highlight-amber">personalised</span>, and more <span className="highlight-green">connected</span>. Every family should have the freedom to shape their child&apos;s education in a way that fits their unique needs, interests, and goals.</p>
